namespace SchoolCanteen
{
    partial class NewConnection
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Введите строку подключения к базе данных";
            // 
            // textBox1
            // 
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(394, 125);
            ...
            this.label2.Text = "Формат ввода:\r\nData Source = [Имя_компьютера]; Integrated Security = SSPI; Initia" +
    "l Catalog = [Имя_БД]";
            // 
            // NewConnection
            // 
